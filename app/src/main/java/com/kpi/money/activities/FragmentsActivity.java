...
import com.kpi.money.fragments.InstructionsFragment;
import com.kpi.money.fragments.RedeemFragment;
import com.kpi.money.fragments.ReferFragment;
import com.kpi.money.fragments.TransactionsFragment;
import com.kpi.money.fragments.VideosFragment;
        ...
        if (Type != null) {
            ...
            switch (Type){
                ...
                case "spin" :
                    ...
                    startActivity(new Intent(ctx, SpinWheelActivity.class));
                    finish();
                ...
                case "home" :
                    ...
                    startActivity(new Intent(ctx, MainActivityvTwo.class));
                    finish();
